...
{'': ['*'],
 'yacfg': ['profiles/_libs/*',
           ...
           'profiles/amq_broker/7.10.0/*',
           'profiles/amq_broker/7.10.0/_modules/bootstrap_xml/*',
           'profiles/amq_broker/7.10.0/_modules/broker_xml/store/*',
           'profiles/amq_broker/7.10.0/cluster/*',
           'profiles/amq_broker/7.10.0/ha/*',
           'profiles/amq_broker/7.10.0/performance/*',
           'profiles/amq_broker/7.10.0/security/gssapi/*',
           'profiles/amq_broker/7.10.0/security/gssapi_ldap/*',
           'profiles/amq_broker/7.10.0/store/jdbc/*',
           ...
           'profiles/artemis/2.21.0/*',
           'profiles/artemis/2.21.0/_modules/artemis_profile/*',
           'profiles/artemis/2.21.0/_modules/artemis_profile/performance/*',
           'profiles/artemis/2.21.0/_modules/bootstrap_xml/*',
           'profiles/artemis/2.21.0/_modules/broker_xml/*',
           'profiles/artemis/2.21.0/_modules/broker_xml/acceptors/*',
           ...
           'profiles/artemis/2.21.0/_modules/broker_xml/security_settings/*',
           'profiles/artemis/2.21.0/_modules/broker_xml/store/*',
           'profiles/artemis/2.21.0/_modules/jolokia_access/*',
           'profiles/artemis/2.21.0/_modules/logging_properties/*',
           'profiles/artemis/2.21.0/_modules/login_config/*',
           'profiles/artemis/2.21.0/_modules/management_xml/*',
           'profiles/artemis/2.21.0/_modules/security/jdk_gssapi/*',
           'profiles/artemis/2.21.0/_modules/users_roles_security/*',
           'profiles/artemis/2.21.0/cluster/*',
           'profiles/artemis/2.21.0/ha/*',
           'profiles/artemis/2.21.0/performance/*',
           'profiles/artemis/2.21.0/security/gssapi/*',
           'profiles/artemis/2.21.0/security/gssapi/ssl_tls/*',
           'profiles/artemis/2.21.0/security/gssapi_ldap/*',
           'profiles/artemis/2.21.0/store/jdbc/*',
           ...
           'templates/artemis/2.21.0/*',
           'templates/artemis/2.21.0/modules/broker_xml/*',
           'templates/artemis/2.21.0/modules/broker_xml/ha_policy/*',
           'templates/artemis/2.21.0/modules/broker_xml/security_settings/*',
           'templates/artemis/2.21.0/modules/broker_xml/store/*',
